...
Este é um repositório para os exercícios do meu curso de Lógica de Programação com JavaScript.
Aqui eu estudo conteúdos teóricos e práticos para desenvolver minhas habilidades em programação.
...
Introdução: Uma visão geral sobre o curso e os conceitos básicos de programação.
Variáveis e Tipos de Dados: Aprendendo a declarar variáveis e os tipos de dados que o JavaScript suporta.
...
Este repositório é um material de apoio para o meu curso de Lógica de Programação com JavaScript.
